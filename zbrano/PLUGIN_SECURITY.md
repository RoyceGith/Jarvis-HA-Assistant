# ZBRANO MCP Plugin Security Model

ZBRANO v0.10.0 uses deny-by-default controls for MCP plugins.
...
Write-capable MCP tools are excluded until ZBRANO has a complete approval-request interface and auditable approval lifecycle.
