    ...
    <div class="about-shell">
      ...
      <section class="about-section" aria-labelledby="about-capabilities-title">
        ...
        <div class="about-feature-grid">
          ...
          <article class="about-feature"><span class="about-feature-icon" aria-hidden="true">MEM</span><h4>Memory and organization</h4><p>Turn local knowledge into clear spaces and reusable note templates, alongside files, contacts, appointments, and reminders.</p><ul><li>Visual Memory Database</li><li>Custom categories and Template Studio</li><li>Private conversational Fast Memory</li><li>Shared files, contacts, calendar, and reminders</li></ul></article>
