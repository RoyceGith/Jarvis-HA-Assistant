    ...
    <div class="about-shell">
      <section class="about-hero">
        <div class="about-hero-copy">
          ...
          <p>ZBRANO brings conversation, Home Assistant, useful memory, visual automations, notifications, and connected services into one clear workspace.</p>
          <div class="about-badges" aria-label="ZBRANO principles"><span>Built for Home Assistant</span><span>Owner-controlled access</span><span>Visible decisions</span></div>
      ...
      <section class="about-section" aria-labelledby="about-capabilities-title">
        ...
        <div class="about-feature-grid">
          ...
          <article class="about-feature"><span class="about-feature-icon" aria-hidden="true">MEM</span><h4>Memory and organization</h4><p>Keep useful preferences and context close to the assistant, alongside files, contacts, appointments, and reminders.</p><ul><li>Private Fast Memory</li><li>Built-in, review-controlled Knowledge Memory</li><li>Shared files and contact import</li><li>Calendar, birthday, and delivery reminders</li></ul></article>
      ...
      <section class="about-trust">
        ...
        <div class="about-actions"><button id="about-open-devices" type="button">Choose device access</button><button id="about-open-automations" type="button">Explore automations</button></div>
      </section>
    </div>`;
