    ...
    <div class="about-shell">
      ...
      <section class="about-section" aria-labelledby="about-capabilities-title">
        ...
        <div class="about-feature-grid">
          ...
          <article class="about-feature"><span class="about-feature-icon" aria-hidden="true">MEM</span><h4>Memory and organization</h4><p>Keep useful preferences and context close to the assistant, alongside files, contacts, appointments, and reminders.</p><ul><li>Private Fast Memory</li><li>Optional review-controlled Workshop Memory</li><li>Shared files and contact import</li><li>Calendar, birthday, and delivery reminders</li></ul></article>
