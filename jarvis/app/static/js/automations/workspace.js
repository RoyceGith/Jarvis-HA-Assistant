(() => {
  ...
  function actionTaskKey(item){const preferred=String(item.task_template||"");if(["turn_on","turn_off","toggle","notification","delay","wait","service"].includes(preferred))return preferred;const kind=item.kind||"service",service=String(item.service||"");if(kind==="notification")return "notification";if(kind==="delay")return "delay";if(kind==="wait_state")return "wait";if(service.endsWith(".turn_on"))return "turn_on";if(service.endsWith(".turn_off"))return "turn_off";if(service.endsWith(".toggle"))return "toggle";return "service"}
  ...
  function renderActionTaskPalette(root){
    ...
    const iconCodes={turn_on:"&#9889;",turn_off:"&#9675;",toggle:"&#8644;",notification:"&#9993;",delay:"&#9201;",wait:"&#9655;",service:"&#9881;"};
  ...
  function actionStepHtml(item,attributes){
    ...
    const labels={turn_on:"Power on",turn_off:"Power off",toggle:"Toggle",notification:"Notification",delay:"Delay",wait:"Wait until",service:"Custom service"};
