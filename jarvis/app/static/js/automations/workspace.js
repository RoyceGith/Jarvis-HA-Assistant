(() => {
  ...
  const studioPanels={
    details:{title:"1. Setup & safety",help:"Name this automation, choose its authority, presence, and sleep-hour behavior.",fields:[["automation-name","Automation name"],["automation-objective","What should it help with?"],["automation-require-presence","Require presence"],["automation-presence","Who must be present?"],["automation-risk","Device type"],["automation-execution-policy","How should ZBRANO respond?"],["automation-sleep-hours-enabled","Pause during sleep hours"],["automation-sleep-hours-start","Sleep starts"],["automation-sleep-hours-end","Sleep ends"],["automation-run-during-sleep-hours","Security automation — run during sleep hours"],["automation-max-actions","Most times this may run in one hour"],["automation-reversible-only","Only allow automatic actions that can be undone"],["automation-notify-action","Tell me after it runs"],["automation-enabled","Enable automation on saving"]]},
