(() => {
  ...
  const studioPanels={
    ...
    decision:{title:"Decision",help:"Choose this automation's operating mode and where its suggestions are delivered. The global policy remains the safety ceiling.",fields:[["automation-proposal","Suggestion wording"],["automation-confidence","Minimum confidence"],["automation-cooldown","Cooldown minutes"],["automation-risk","Risk class"],["automation-execution-policy","Operating mode"],["automation-delivery-voice","Speak suggestions"],["automation-delivery-center","Show in Studio inbox"],["automation-delivery-push","Send Home Assistant notification"]]},
