...
indented Automation Studio navigation entries. Saved automations use compact rows
and keep each visual flow collapsed until its own expand control is opened.
