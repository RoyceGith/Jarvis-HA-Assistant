...
Version 0.13.65 fixes graphical connector hit testing so arrows cannot obstruct
Context or other blocks, including during the container browser validation.
