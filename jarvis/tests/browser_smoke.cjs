...
async function main() {
  ...
  try {
    ...
    assert.match(await page.locator("#automation-flow-preview").innerText(), /Outcome 1/i);
    ...
    assert.match(await page.locator('[data-flow-branch-drop="0"] [data-flow-kind="decision"]').innerText(), /Outcome 1/i);
