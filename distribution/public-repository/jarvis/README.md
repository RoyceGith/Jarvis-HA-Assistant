...
Version 0.13.64 provides a visual automation builder with Trigger, Context,
Decision, and Action blocks, a node canvas, and block-specific settings. The full
Advanced editor remains available, and existing stored automations are preserved.
