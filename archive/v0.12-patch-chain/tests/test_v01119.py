...
PATCH = (ROOT / "zbrano/apply_frontend_repair_and_device_picker_v01119.py").read_text(encoding="utf-8")
CHECKER = (ROOT / "zbrano/validate_inline_js.py").read_text(encoding="utf-8")
