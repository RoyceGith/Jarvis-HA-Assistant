...
PATCH = (ROOT / "zbrano/apply_release_memory_sync_v01221.py").read_text(encoding="utf-8")
DOCKER = (ROOT / "zbrano/Dockerfile").read_text(encoding="utf-8")
CONFIG = (ROOT / "zbrano/config.yaml").read_text(encoding="utf-8")
README = (ROOT / "README.md").read_text(encoding="utf-8")
MANIFEST = json.loads((ROOT / "zbrano/release_manifest.json").read_text(encoding="utf-8"))
VALIDATOR = (ROOT / "zbrano/validate_release_manifest.py").read_text(encoding="utf-8")
