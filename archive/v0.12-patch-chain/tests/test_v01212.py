...
PATCH = (ROOT / "zbrano/apply_workshop_task_approval_v01212.py").read_text(encoding="utf-8")
...
def test_v01212_build_order_and_version():
    ...
    assert "./apply_workshop_task_approval_v01212.py" in DOCKER
    assert 'version="0.12.12"' in PATCH
