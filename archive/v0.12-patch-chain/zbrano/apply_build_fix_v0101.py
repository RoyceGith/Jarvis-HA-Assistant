...
def replace_required(text: str, old: str, new: str, label: str) -> str:
    if old not in text:
        raise RuntimeError(f"ZBRANO v0.10.1 build fix could not find: {label}")
