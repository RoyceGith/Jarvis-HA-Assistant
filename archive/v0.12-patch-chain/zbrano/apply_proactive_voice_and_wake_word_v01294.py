...
(() => {
  ...
  function recognitionLanguage(){const preferred=String(zbranoPreferences?.preferred_language||"").trim();return preferred&&preferred!=="auto"?preferred:document.documentElement.lang||navigator.language||"en-US"}
