...
DEVELOPER_FEATURE_SPECS = {
    "attachments": {
        ...
        "files": (
            "zbrano/apply_attachment_upload_fix_v0122.py",
            "zbrano/apply_shared_files_and_diagnostics_v0123.py",
            "zbrano/app/main.py",
    ...
    "shared_files": {
        ...
        "files": (
            "zbrano/apply_shared_files_and_diagnostics_v0123.py",
            "zbrano/apply_shared_files_runtime_recovery_v01130.py",
            "zbrano/app/main.py",
            "zbrano/app/static/index.html",
        ),
    },
    "new_chat": {
        ...
        "files": (
            "zbrano/apply_new_chat_draft_fix_v01121.py",
            "zbrano/apply_new_chat_shared_files_fix_v01122.py",
            "zbrano/apply_new_chat_sidebar_draft_v01123.py",
            "zbrano/app/static/index.html",
        ),
    },
    "plugin_catalog": {
        ...
        "files": (
            "zbrano/apply_plugin_catalog_v0110.py",
            "zbrano/apply_plugin_manager_recovery_v01128.py",
            "zbrano/apply_catalog_and_plugin_compact_v01131.py",
            "zbrano/app/main.py",
        ),
    },
    "plugins": {
        ...
        "files": (
            "zbrano/apply_plugin_manager_recovery_v01128.py",
            "zbrano/apply_github_tool_approval_policy_v01129.py",
            "zbrano/app/static/index.html",
        ),
    },
    "entities": {
    ...
    "settings": {
        ...
        "files": ("zbrano/app/main.py", "zbrano/app/static/index.html"),
    },
    "voice": {
        "title": "Voice",
        ...
        "files": ("zbrano/app/main.py", "zbrano/app/static/index.html", "zbrano/config.yaml"),
    },
    "workshop_memory": {
        ...
        "files": ("zbrano/app/main.py", "zbrano/config.yaml"),
    },
    "developer": {
        ...
        "files": (
            "zbrano/apply_developer_mode_self_diagnostics_v0120.py",
            "zbrano/apply_shared_files_and_diagnostics_v0123.py",
            "zbrano/app/main.py",
        ),
    },
