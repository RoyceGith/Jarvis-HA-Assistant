...
def patch_frontend(frontend: str) -> str:
    ...
    .message.zbrano code { white-space: break-spaces; overflow-wrap: anywhere; word-break: break-word; }
    .core-stage.neuron-intense #brain-network { opacity: 1 !important; }
    body.zbrano-input-active .core-stage.neuron-intense #brain-network { opacity: 1 !important; }
