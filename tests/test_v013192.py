...
RUNTIME = (ROOT / "jarvis/app/services/agent_runtime.py").read_text(encoding="utf-8")
RESPONSES = (ROOT / "jarvis/app/services/openai_responses.py").read_text(encoding="utf-8")
