...
HA_CONTROL = (ROOT / "jarvis/app/services/ha_control.py").read_text(encoding="utf-8")
...
class FastHomeAssistantControlReleaseTests(unittest.TestCase):
    ...
    def test_local_control_runs_before_workshop_tool_preparation(self):
        ...
        stream = MAIN[MAIN.index("async def _run_jarvis_stream_events("):MAIN.index("async def run_jarvis_stream(")]
