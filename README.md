...
Version 0.13.65 keeps decorative diagram connectors outside pointer hit testing,
so every visual block remains selectable and the container browser gate completes.
