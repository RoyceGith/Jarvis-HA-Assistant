...
Version 0.13.66 adds bounded OR triggers, ALL/ANY state conditions, and ordered
Home Assistant action sequences directly to the visual block inspector. Existing
single-trigger automations remain compatible.
